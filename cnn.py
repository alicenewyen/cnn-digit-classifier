...
# FILENAME: cnn.py
# SPECIFICATION: This program builds and trains a Convolutional Neural Network (CNN)
#                using TensorFlow and Keras to classify 32x32 grayscale digit images (0-9).
